//
//  MessageWebSocketClientUrlSession.swift
...
@available(iOS 13.0, *)
public class MessageWebSocketClientUrlSession: NSObject {
    static let shared = MessageWebSocketClientUrlSession()
...
@available(iOS 13.0, *)
extension MessageWebSocketClientUrlSession: URLSessionWebSocketDelegate {
